...
<html>
    <head>
       ...
       <body>
        ...
        <form name='reg' method='post' id='registra' action="<?php echo e(route('regi')); ?>">    
        <?php echo csrf_field(); ?>
                <p>
...
</html><?php /**PATH C:\Users\corra\OneDrive\Desktop\XAMPP\htdocs\hwk2\resources\views/regi.blade.php ENDPATH**/ ?>
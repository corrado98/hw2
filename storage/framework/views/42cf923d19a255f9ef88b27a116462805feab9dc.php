<html>
    <head>
       ...
       <body>
        ...
        <form name='log_form' method='post' action="<?php echo e(route('home')); ?>">
        <?php echo csrf_field(); ?>    
            <p>
...
</html><?php /**PATH C:\Users\corra\OneDrive\Desktop\XAMPP\htdocs\hwk2\resources\views/login.blade.php ENDPATH**/ ?>